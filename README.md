...
- `blur(strength, color, color_opacity)` is a `bg_color` value that frosts the panel's backdrop — it blurs whatever is behind it and tints it, like `bg_color: blur(2, BLACK, 0.2)`.
